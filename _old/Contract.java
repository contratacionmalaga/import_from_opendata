 ...
 * <p>
 * Permite registrar la información básica del contrato como su identificador, la fecha de emisión y
 * la relación con el {@link TenderResult} del que se origina.
 * </p>
 *
 * <p>
 * Se almacena en la tabla <b>contract</b> y hereda de {@link AuditableCreatedAt}, aportando campos de
 * auditoría (creación, modificación, usuario, etc.).
 * </p>
 *
...
@Entity
@Table(name = "contract")
public class Contract extends AuditableCreatedAt {

  /**
   * Identificador único de la entidad Contract. Generado automáticamente como UUID.
   */
  @Id
  ...
  /**
   * Relación uno a uno con el resultado de la licitación ({@link TenderResult}) del que deriva este
   * contrato.
   * <p>
   * Eliminación en cascada: si se elimina el tender result asociado, también se elimina el
   * contrato.
   * </p>
   */
  @OneToOne(
