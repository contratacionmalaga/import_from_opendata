...
/**
 * Entidad que representa la lista corta de operadores económicos dentro de un proceso de licitación
 * ({@link TenderingProcess}).
 * <p>
 * Se utiliza para definir criterios objetivos y numéricos relacionados con la selección de un
 * número limitado de candidatos dentro de un procedimiento competitivo.
 * </p>
 *
 * <p>
 * Hereda de {@link AuditableCreatedAt}, por lo que incluye campos de auditoría (fecha de creación, última
...
public class EconomicOperatorShortList extends AuditableCreatedAt {

  /**
   * Identificador único de la lista corta en formato UUID. Se genera automáticamente al persistir
  ...
  /**
   * Relación uno a uno con el proceso de licitación ({@link TenderingProcess}) al que pertenece
   * esta lista corta.
   * <p>
   * La relación está configurada con eliminación en cascada para asegurar la integridad
   * referencial.
   * </p>
   */
  @OneToOne(
  ...
  /**
   * Devuelve una representación en cadena de la entidad, mostrando los valores principales de sus
   * atributos.
   *
   * @return cadena con los valores de {@code description}, {@code expectedQuantity},
   * {@code maximumQuantity} y {@code minimumQuantity}.
   */
  @Override
