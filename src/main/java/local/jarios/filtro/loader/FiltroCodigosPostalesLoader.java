...
public class FiltroCodigosPostalesLoader implements FiltroLoader {
  ...
  @Getter private List<OrganoContratacion> listaOcsFiltro = new ArrayList<>();
  ...
  public void cargar(OpenDataExecutionContext context) throws PropertiesManagerException {
    ...
    String filtroCodigosPostales =
        propertyManager.getProperty(PropertiesFiles.FILTER, PropertiesKeys.FILTER_CODIGOS_POSTALES);
    ...
    if (StringHelper.isValidFiltroCodigosPostales(filtroCodigosPostales)) {
      ...
      log.debug("Lista de los filtros de códigos postales: {}", codigosPostalesValidos);
      ...
      context.setFiltroCodigosPostales(null);
