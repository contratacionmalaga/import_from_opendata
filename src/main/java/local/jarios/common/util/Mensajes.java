...
public final class Mensajes {
  ...
  public static final String FILE_NOT_EXIST = "Fichero no existe. {}";
  public static final String NOT_FILE = "No es un fichero. {}";
  public static final String FILE_NOT_READ = "No se puede leer. {}";
  public static final String MENSAJE_VALOR_SWITCH_INCORRECTO = "EL VALOR DE {}: ({}) NO ES VÁLIDO";
  ...
  public static final String ENTRY_NO_FILTRO_ORGANOS_CONTRATACION =
      "El Entry no cumple el filtro ORGANOS CONTRATACIÓN.";
  ...
  public static final String NREGISTROS_OC_EXCEl = "Nº de órganos de contratación en excel: {}";

  /** Mensaje insertar */
  public final String MSG_ENTRYOPCION_INSERTAR = "El Entry no figura en Memoria.";
