 ...
 * <ul>
 *     <li>Códigos CNAE (INE)</li>
 *     <li>Listado DIR3 (Centro de Transferencia Tecnológica)</li>
 *     <li>Órganos de Contratación (Ministerio de Hacienda - Datos Abiertos)</li>
 * </ul>
 *
 * @author Juan Antonio
 */
public final class ConstantesExcel {
   ...
   */
  public static final String EXCEL_OC_URL = "https://contrataciondelsectorpublico.gob.es/datosabiertos/OrganosContratacion.xlsx";
