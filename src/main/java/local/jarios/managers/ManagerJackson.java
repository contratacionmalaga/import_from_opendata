 ...
 * <b>Jackson</b>.
 *
 * <p>Su principal propósito es ofrecer un método estático para convertir cualquier objeto Java en
 * una representación JSON con <i>pretty printing</i> y soporte completo para clases de fecha y hora
 * de Java 8 ({@link java.time.LocalDateTime}, {@link java.time.LocalDate}, etc.).
 *
 * <h2>Características principales:</h2>
 *
 * <ul>
 *   <li>Registro automático del módulo {@link JavaTimeModule} para manejar correctamente las clases
 *       de fecha y hora modernas.
 *   <li>Salida con formato legible (activación de {@link SerializationFeature#INDENT_OUTPUT}).
 *   <li>Evita errores de serialización en objetos sin propiedades ({@link
 *       SerializationFeature#FAIL_ON_EMPTY_BEANS} = false).
 *   <li>Exclusión de valores {@code null} en la salida JSON mediante {@link
 *       JsonInclude.Include#NON_NULL}.
 * </ul>
 *
 * <p>Esta clase es <b>final</b> y tiene un constructor privado para impedir su instanciación,
 * promoviendo así su uso exclusivamente como utilidad estática.
 *
...
public final class ManagerJackson {
   ...
   *
   * <p>Si ocurre un error durante el proceso de serialización, se lanza una {@link
   * RuntimeException} con el detalle de la causa.
   *
