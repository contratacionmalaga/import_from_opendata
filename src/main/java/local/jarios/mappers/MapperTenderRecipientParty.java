...
/**
 * Clase utilitaria para mapear objetos del modelo Codice {@link PartyType}
 * a la entidad persistente {@link TenderRecipientParty}.
 * <p>
 * Esta clase contiene métodos estáticos para crear instancias de
 * {@link TenderRecipientParty} asociadas a {@link TenderingTerms} a partir
 * de objetos de tipo {@link PartyType}.
 * </p>
 * <p>
