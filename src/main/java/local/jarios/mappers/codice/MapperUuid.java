 ...
 * {@link Uuid}.
 *
 * <p>Esta clase proporciona un método estático que crea una lista de objetos {@link Uuid} asociados
 * a una entidad {@link ContractFolderStatus}. Cada objeto {@link UUIDType} se transforma en un
 * objeto {@link Uuid} copiando su valor y el esquema de nombre. La clase es estática y no
 * instanciable. <b>Autor:</b> Juan Antonio <b>Fecha:</b> 06/07/2024 <b>Equipo:</b> Juan Antonio
 */
@Slf4j
public final class MapperUuid {
  ...
  public static List<Uuid> getListUuidFromType(
      ContractFolderStatus contractFolderStatus, List<UUIDType> listUuidType) {
