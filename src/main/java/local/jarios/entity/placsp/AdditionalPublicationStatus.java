...
public class AdditionalPublicationStatus extends Auditable {
   ...
   * <p>
   * Clave primaria, generado automáticamente. No puede ser actualizado ni nulo.
   * </p>
   */
  @Id
   ...
   * <p>
   * Relación muchos a uno con {@link NoticeInfo}. La carga es perezosa y se propaga en cascada
   * todas las operaciones. La eliminación en cascada se asegura con la definición de clave
   * foránea.
   * </p>
   */
  @ManyToOne(
   ...
   * <p>
   * Relación uno a muchos con {@link AdditionalPublicationRequest}. Operaciones en cascada para
   * todas las acciones, y eliminación en cascada (orphan removal) al desvincular.
   * </p>
   */
   ...
   * <p>
   * Relación uno a muchos con {@link AdditionalPublicationDocumentReference}. Operaciones en
   * cascada para todas las acciones, y eliminación en cascada (orphan removal) al desvincular.
   * </p>
   */
  @OneToMany(mappedBy = "additionalPublicationStatus", cascade = CascadeType.ALL, orphanRemoval = true)
