 ...
 * desde Internet.
 *
 * <p>Esta entidad contiene información sobre el medio de publicación y mantiene las relaciones con
 * la información del aviso relacionado, así como con las solicitudes y referencias de documentos de
 * publicación asociadas.
 *
 * <p>Hereda campos auditables comunes de {@link AuditableCreatedAt}.
 *
 * @author Juan Antonio
 * @since 04/06/2024
 */
...
public class AdditionalPublicationStatus extends AuditableCreatedAt {
  ...
  @Column(name = "publication_media_name", length = TamanoCampos.TAMANO_500)
      ...
      foreignKey =
          @ForeignKey(
              ...
              foreignKeyDefinition =
                  "FOREIGN KEY (notice_info_id) REFERENCES notice_info(id) ON DELETE CASCADE"))
  private NoticeInfo noticeInfo;

  /** Lista de solicitudes de publicación adicionales asociadas a este estado. */
  @OneToMany(
      mappedBy = "additionalPublicationStatus",
  ...
  @OneToMany(
      ...
      cascade = CascadeType.ALL,
      orphanRemoval = true)
  private List<AdditionalPublicationDocumentReference> additionalPublicationDocumentReferenceList =
      new ArrayList<>();
}
