...
public class ProcurementProjectLot extends AuditableCreatedAt {
  ...
  @Column(name = "lote", length = Constantes.TAMANO_MAXIMO_CAMPO_50)
  private String lote;
  ...
  // RELACIONES HIJAS
  // =========================================================================
  @OneToMany(mappedBy = "procurementProjectLot", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
