 ...
 * público.
 *
 * <p>Una modificación de contrato puede afectar tanto a las condiciones económicas como a las
 * condiciones de duración, así como contener información adicional sobre el contrato original y sus
 * lotes.
 *
 * <p>Cada registro se corresponde con un evento de modificación en la tabla
 * <b>contract_modification</b>.
 *
 * <p>Hereda de {@link AuditableCreatedAt}, por lo que incluye los metadatos de auditoría (fecha de
...
public class ContractModification extends AuditableCreatedAt {
  ...
  @Column(name = "contract_id", nullable = false, length = TamanoCampos.TAMANO_50)
  private String contractId;

  /** Identificador de la modificación del contrato. */
  @Column(name = "contract_modification_id", length = TamanoCampos.TAMANO_50)
   ...
   *
   * <p>Relación muchos-a-uno con {@link ContractFolderStatus}. Incluye eliminación en cascada para
   * mantener integridad.
   */
