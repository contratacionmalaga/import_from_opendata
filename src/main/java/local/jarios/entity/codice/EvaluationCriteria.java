 ...
 *
 * <p>Estos criterios permiten definir requisitos técnicos mínimos, umbrales de participación y el
 * tipo de solvencia esperada. También pueden asociarse a nivel de lote dentro de un proceso de
 * contratación pública.
 *
 * <p>Cada instancia de esta entidad se corresponde con un registro en la tabla
 * <b>evaluation_criteria</b> de la base de datos.
 *
 * <p>Hereda de {@link AuditableCreatedAt}, por lo que incluye metadatos de auditoría (fecha de
...
public class EvaluationCriteria extends AuditableCreatedAt {
  ...
  @Column(name = "evaluation_criteria_type_code", length = TamanoCampos.TAMANO_50)
  private String evaluationCriteriaTypeCode;

  /**
   * Descripción detallada del criterio de evaluación.
   *
   * <p>Se almacena como texto largo (tipo {@code TEXT} en la base de datos).
   */
   ...
   *
   * <p>La relación está configurada con eliminación en cascada para mantener la integridad
   * referencial.
   */
