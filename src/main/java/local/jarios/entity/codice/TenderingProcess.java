...
public class TenderingProcess extends AuditableCreatedAt {
  ...
  @Column(name = "procedure_code", length = TamanoCampos.TAMANO_50)
  ...
  @Column(name = "submission_method_code", length = TamanoCampos.TAMANO_50)
  private String submissionMethodCode;

  // 4.34 Limitación del número de licitadores - Número de lotes a los que se debe ofertar
  @Column(name = "part_presentation_code", length = TamanoCampos.TAMANO_50)
  ...
  // 4.34 Limitación del número de licitadores - Número máximo de lotes que se puede adjudicar a un
  // licitador
