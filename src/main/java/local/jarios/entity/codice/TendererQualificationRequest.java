...
@NoArgsConstructor
@Entity
@Table(name = "tenderer_qualification_request")
...
public class TendererQualificationRequest extends AuditableCreatedAt {
  ...
  // Título habilitante: Descripción textual de los requisitos específicos del operador económico
  // para poder
  // participar en la licitación.
  @Column(name = "personal_situation", columnDefinition = "TEXT")
  private String personalSituation;

  // Solvencia requerida: Descripción textual de la información y trámites necesarios para evaluar
  // si se cumplen
  ...
  @JoinColumn(
      ...
      foreignKey =
          @ForeignKey(
              name = "tendererqualificationrequest_tt",
  ...
  @OneToMany(
      mappedBy = "tendererQualificationRequest",
      cascade = CascadeType.ALL,
      orphanRemoval = true,
      fetch = FetchType.LAZY)
  private List<EvaluationCriteria> evaluationCriteria = new ArrayList<>();

  // Clasificación empresarial solicitada: Especifica las Clasificaciones requeridas para los
  // Licitadores
  @OneToMany(
      mappedBy = "tendererQualificationRequest",
      cascade = CascadeType.ALL,
