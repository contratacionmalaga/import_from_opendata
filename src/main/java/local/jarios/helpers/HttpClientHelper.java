 ...
 * <p>
 * Proporciona métodos estáticos para descargar archivos Excel desde URLs externas, manejando
 * cookies, redirecciones y tiempos de espera.
 * </p>
 *
 * <p>Esta clase es final y no puede ser instanciada.</p>
 *
 * @author Juan
 * @since 2025-06-22
 */
...
public final class HttpClientHelper {
   ...
   * </p>
   *
   * <p>Se espera que el contenido descargado sea un archivo Excel con formato ZIP (.xlsx),
   * aunque esta validación no se realiza explícitamente.
   * </p>
   *
  ...
  public static InputStream downloadExcel(String url) {
    ...
    try {
      ...
      String msg = String.format(
          "[downloadExcel] - Fallo al descargar el Excel desde %s. Error: %s", url,
          ex.getMessage());
      log.debug(msg, ex);
      throw new MiHttpException(msg, ex);
    }
