...
/**
 * Clase helper para la gestión de la importación y procesamiento de entidades {@link
 * OrganoContratacion} desde un fichero Excel.
 *
 * <p>Proporciona métodos estáticos para obtener listas de órganos de contratación desde hojas de
 * cálculo.
 *
...
public final class OcHelper {
  ...
  public static ImportResult<OrganoContratacion> getListaOcFromExcelInternet() {
    ...
    return ManagerSpreeadSheet.importarDesdeExcel(
        ConstantesExcel.EXCEL_OC_URL, ManagerSpreeadSheet::getListaOcsFromSheet);
  }
}
