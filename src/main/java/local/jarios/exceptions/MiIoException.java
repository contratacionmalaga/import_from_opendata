 ...
 * (I/O).
 *
 * <p>Esta excepción se lanza típicamente cuando ocurre un error al leer o escribir archivos,
 * acceder a recursos externos (como Excel o conexiones remotas), o durante la manipulación de
 * flujos de datos.
 *
 * <p><strong>Uso recomendado:</strong> Capturar excepciones {@link java.io.IOException} u otras
 * relacionadas y envolverlas en esta clase para proporcionar un contexto más claro dentro de la
 * aplicación.
 *
 * @author Juan
 * @since 28/12/2024
