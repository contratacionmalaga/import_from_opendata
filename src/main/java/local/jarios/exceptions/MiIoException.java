...
/**
 * Excepción personalizada que representa errores relacionados con operaciones de entrada/salida (I/O).
 * <p>
 * Esta excepción se lanza típicamente cuando ocurre un error al leer o escribir archivos,
 * acceder a recursos externos (como Excel o conexiones remotas), o durante la manipulación de flujos de datos.
 * </p>
 *
 * <p><strong>Uso recomendado:</strong> Capturar excepciones {@link java.io.IOException} u otras relacionadas
